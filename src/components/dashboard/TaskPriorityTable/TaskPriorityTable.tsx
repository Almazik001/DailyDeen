import type { CategoryRow } from '../TaskCategoriesTable/TaskCategoriesTable'
import styles from './TaskPriorityTable.module.scss'

type TaskPriorityTableProps = {
  rows: CategoryRow[]
  ...
  return (
    <section className={styles.section}>
      <div className={styles.sectionHeader}>
        <h3 className={styles.sectionTitle}>Task Priority</h3>
      </div>
